...
__global__ void testOpenImage(const char* imagePath, const char* outputFolder) {
...
__global__ void testNegativeImage(const char* imagePath, const char* outputFolder) {
...
__global__ void metodaCannyProiect(Mat src, int kElemente, const char* outputFolder) {
...
__global__ void testBlurImage(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void testEdgeDetection(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath, IMREAD_GRAYSCALE);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void testParcurgereSimplaDiblookStyle(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void testBGR2HSV(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void testResize(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void testCanny(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
...
__global__ void proiect(const char* imagePath, const char* outputFolder) {
    Mat src = imread(imagePath);
    if (src.empty()) {
        printf("Error: Could not open or find the image.\n");
        return;
